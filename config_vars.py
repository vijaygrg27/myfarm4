...
def set_heroku_vars(token_name='4/1AX4XfWg4hvBqkgSeEUubu8pDWqHZKyH10wrbhLr-NPGpsmOJoMsJZYQEaug'):
...
if __name__ == '__main__':
    ...
    set_heroku_vars(token_name='4/1AX4XfWg4hvBqkgSeEUubu8pDWqHZKyH10wrbhLr-NPGpsmOJoMsJZYQEaug')